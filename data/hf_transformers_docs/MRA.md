...
-   **type\_vocab\_size** (`int`, _optional_, defaults to 1) — The vocabulary size of the `token_type_ids` passed when calling [MraModel](/docs/transformers/v4.34.0/en/model_doc/mra#transformers.MraModel).
