...
[< source \>](https://github.com/huggingface/transformers/blob/v4.34.0/src/transformers/models/nezha/configuration_nezha.py#L9)
...
-   **vocab\_size** (`int`, optional, defaults to 21128) — Vocabulary size of the NEZHA model. Defines the different tokens that can be represented by the _inputs\_ids_ passed to the forward method of [NezhaModel](/docs/transformers/v4.34.0/en/model_doc/nezha#transformers.NezhaModel).
...
-   **intermediate\_size** (`int`, optional, defaults to 3072) — The dimensionality of the “intermediate” (i.e., feed-forward) layer in the Transformer encoder.
...
-   **max\_position\_embeddings** (`int`, optional, defaults to 512) — The maximum sequence length that this model might ever be used with. Typically set this to something large (e.g., 512 or 1024 or 2048).
-   **type\_vocab\_size** (`int`, optional, defaults to 2) — The vocabulary size of the _token\_type\_ids_ passed into [NezhaModel](/docs/transformers/v4.34.0/en/model_doc/nezha#transformers.NezhaModel).
...
-   **classifier\_dropout** (`float`, optional, defaults to 0.1) — The dropout ratio for attached classifiers.
...
This is the configuration class to store the configuration of an [NezhaModel](/docs/transformers/v4.34.0/en/model_doc/nezha#transformers.NezhaModel). It is used to instantiate an Nezha model according to the specified arguments, defining the model architecture. Instantiating a configuration with the defaults will yield a similar configuration to that of the Nezha [sijunhe/nezha-cn-base](https://huggingface.co/sijunhe/nezha-cn-base) architecture.
...
[< source \>](https://github.com/huggingface/transformers/blob/v4.34.0/src/transformers/models/nezha/modeling_nezha.py#L859)

( config add\_pooling\_layer = True )

Parameters

-   **config** ([NezhaConfig](/docs/transformers/v4.34.0/en/model_doc/nezha#transformers.NezhaConfig)) — Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from\_pretrained()](/docs/transformers/v4.34.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
[< source \>](https://github.com/huggingface/transformers/blob/v4.34.0/src/transformers/models/nezha/modeling_nezha.py#L898)
...
The [NezhaModel](/docs/transformers/v4.34.0/en/model_doc/nezha#transformers.NezhaModel) forward method, overrides the `__call__` special method.
...
[< source \>](https://github.com/huggingface/transformers/blob/v4.34.0/src/transformers/models/nezha/modeling_nezha.py#L1039)
...
[< source \>](https://github.com/huggingface/transformers/blob/v4.34.0/src/transformers/models/nezha/modeling_nezha.py#L1057)

( input\_ids: typing.Optional\[torch.Tensor\] = None attention\_mask: typing.Optional\[torch.Tensor\] = None token\_type\_ids: typing.Optional\[torch.Tensor\] = None head\_mask: typing.Optional\[torch.Tensor\] = None inputs\_embeds: typing.Optional\[torch.Tensor\] = None labels: typing.Optional\[torch.Tensor\] = None next\_sentence\_label: typing.Optional\[torch.Tensor\] = None output\_attentions: typing.Optional\[bool\] = None output\_hidden\_states: typing.Optional\[bool\] = None return\_dict: typing.Optional\[bool\] = None ) → `transformers.models.nezha.modeling_nezha.NezhaForPreTrainingOutput` or `tuple(torch.FloatTensor)`
...
A `transformers.models.nezha.modeling_nezha.NezhaForPreTrainingOutput` or a tuple of `torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various elements depending on the configuration ([NezhaConfig](/docs/transformers/v4.34.0/en/model_doc/nezha#transformers.NezhaConfig)) and inputs.
...
The [NezhaForPreTraining](/docs/transformers/v4.34.0/en/model_doc/nezha#transformers.NezhaForPreTraining) forward method, overrides the `__call__` special method.
...
[< source \>](https://github.com/huggingface/transformers/blob/v4.34.0/src/transformers/models/nezha/modeling_nezha.py#L1141)
...
[< source \>](https://github.com/huggingface/transformers/blob/v4.34.0/src/transformers/models/nezha/modeling_nezha.py#L1165)
...
The [NezhaForMaskedLM](/docs/transformers/v4.34.0/en/model_doc/nezha#transformers.NezhaForMaskedLM) forward method, overrides the `__call__` special method.
...
[< source \>](https://github.com/huggingface/transformers/blob/v4.34.0/src/transformers/models/nezha/modeling_nezha.py#L1247)
...
[< source \>](https://github.com/huggingface/transformers/blob/v4.34.0/src/transformers/models/nezha/modeling_nezha.py#L1257)
...
The [NezhaForNextSentencePrediction](/docs/transformers/v4.34.0/en/model_doc/nezha#transformers.NezhaForNextSentencePrediction) forward method, overrides the `__call__` special method.
...
[< source \>](https://github.com/huggingface/transformers/blob/v4.34.0/src/transformers/models/nezha/modeling_nezha.py#L1350)
...
[< source \>](https://github.com/huggingface/transformers/blob/v4.34.0/src/transformers/models/nezha/modeling_nezha.py#L1366)
...
The [NezhaForSequenceClassification](/docs/transformers/v4.34.0/en/model_doc/nezha#transformers.NezhaForSequenceClassification) forward method, overrides the `__call__` special method.
...
[< source \>](https://github.com/huggingface/transformers/blob/v4.34.0/src/transformers/models/nezha/modeling_nezha.py#L1449)
...
[< source \>](https://github.com/huggingface/transformers/blob/v4.34.0/src/transformers/models/nezha/modeling_nezha.py#L1463)
...
The [NezhaForMultipleChoice](/docs/transformers/v4.34.0/en/model_doc/nezha#transformers.NezhaForMultipleChoice) forward method, overrides the `__call__` special method.
...
[< source \>](https://github.com/huggingface/transformers/blob/v4.34.0/src/transformers/models/nezha/modeling_nezha.py#L1541)
...
[< source \>](https://github.com/huggingface/transformers/blob/v4.34.0/src/transformers/models/nezha/modeling_nezha.py#L1556)
...
The [NezhaForTokenClassification](/docs/transformers/v4.34.0/en/model_doc/nezha#transformers.NezhaForTokenClassification) forward method, overrides the `__call__` special method.
...
[< source \>](https://github.com/huggingface/transformers/blob/v4.34.0/src/transformers/models/nezha/modeling_nezha.py#L1620)
...
[< source \>](https://github.com/huggingface/transformers/blob/v4.34.0/src/transformers/models/nezha/modeling_nezha.py#L1631)
...
The [NezhaForQuestionAnswering](/docs/transformers/v4.34.0/en/model_doc/nezha#transformers.NezhaForQuestionAnswering) forward method, overrides the `__call__` special method.
